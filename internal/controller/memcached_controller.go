...
const memcachedFinalizer = "cache.donaldsebleung.com/finalizer"
...
//+kubebuilder:rbac:groups=cache.donaldsebleung.com,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cache.donaldsebleung.com,resources=memcacheds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cache.donaldsebleung.com,resources=memcacheds/finalizers,verbs=update
...
// We only care about resources that have not been completely deleted
